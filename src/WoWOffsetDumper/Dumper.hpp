...
static std::list<OffsetPattern> funcPatterns
{
	...
	{ "FunctionForSpellAttribute", "40 53 48 83 EC 20 8B D9 85 C9 74 13 E8 ? ? ? ? 8B D0 8B CB 48 83 C4 20 5B E9 ? ? ? ? 33 C0", SignatureType::NORMAL, 0x0, 0x0 },
	...
	{ "SpellBook_FindBaseSpellById", "48 89 5C 24 08 57 48 83 EC 20 48 63 F9 8B DA 85 D2 75 ? E8 ? ? ? ? 8B D8 85 C0 75 ? E8", SignatureType::NORMAL, 0x0, 0x0 },
	...
	{ "Spell_FindSpellOverrideById", "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 41 54 41 55 41 56 41 57 48 83 EC 30 45 0F B6 F0", SignatureType::NORMAL, 0x0, 0x0 },
